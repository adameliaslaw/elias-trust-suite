...
> (#39, `ca7219c`): customers route group extracted (4 handlers). PR 5 open: extract the time route group (6 handlers).**
...
| 6 — Books role + `packages/rules` | #25 | 🟨 **In progress** — PR 1 MERGED (#36): `@elias/rules` + payroll retrofit + tax fixes (6/8). PR 2 MERGED (#37): `server.js` split begun (sales-tax + reports group). PR 3 MERGED (#38): expenses group. PR 4 MERGED (#39): customers group. PR 5 open: time group extracted |
